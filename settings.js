...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "zUYWADTQ#R1HFyWTpXy7xlZyPZSWVaY4EvFqh6cE2ME_IC-RfBT4", // Add your session id
PREFIX: process.env.PREFIX || "/",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94767310665",
DEV: process.env.DEV || "94767310665",
